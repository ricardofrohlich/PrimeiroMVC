...
namespace PrimeiroMVC.Controllers
{
    public class PessoasController : Controller
    {
         ...
         /*public PessoasController(BdApiContext context)
         {
             _context = context;
         }*/
        ...
        {
             BdApiContext _context = new BdApiContext();
              return _context.Pessoas != null ? 
                          View(await _context.Pessoas.ToListAsync()) :
                          Problem("Entity set 'BdApiContext.Pessoas'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BdApiContext.Pessoas'  is null.");
            }
            var pessoa = await _context.Pessoas.FindAsync(id);
            if (pessoa != null)
            {
